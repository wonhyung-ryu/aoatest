...
public class TPDV_HMS_HVAC_CONTROL extends Tx_Packet{
    ...
    private byte [] data = new byte[TPDV_HMS_HVAC_CONTROL_dataLen+12];

    TPDV_HMS_HVAC_CONTROL(){
        ...
        charToBytes_LE(TPDV_HMS_HVAC_CONTROL_dataLen, data, datalenAddr);

        // end frame...consider Byte order
        intToBytes_LE(ENDFRAME, data, TPDV_HMS_HVAC_CONTROL_dataLen+8);
    }
    //운전석 온도 설정 18	32
